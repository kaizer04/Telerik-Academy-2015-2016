...
namespace Telerik.ILS.Common
{
    ...
    public static class StringExtensions
    {
        ...
        /// </summary>
        /// <param name="input">The string to be converted to integer</param>
        /// <returns>Returns variable of type integer if the string is a number, null - otherwise</returns>
        ...
        /// <param name="startFrom">from where to start searching for startString (optional)</param>
